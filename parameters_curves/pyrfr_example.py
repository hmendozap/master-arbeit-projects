...
data_set_prefix = '/home/hmendoza/workspace/RoBO_Setup/random_forest_run/test_data_sets/'

# feature matrix contains one data point per row
features  = np.loadtxt(data_set_prefix+'features13.csv', delimiter=",")

# the responses come in a 1d array
responses =  np.loadtxt(data_set_prefix+'responses13.csv', delimiter=",")
