...
do
    for i in ${datasets};
    do
        python fanova_analysis_autonet_noprepro.py /mhome/mendozah/autonet_${j}/results/experiment/ ${i}_bac /mhome/mendozah/autonet_${j}/results/plots_importance/over_quartile/ 1;
    done;
done;
exit 0
